...
const firebaseConfig = {
    apiKey: "AIzaSyCqPGFw12ZemToYdaOlDARWaKDK91Rqa3U",
    authDomain: "socialgram-b5c73.firebaseapp.com",
    databaseURL: "https://socialgram-b5c73.firebaseio.com",
    projectId: "socialgram-b5c73",
    storageBucket: "socialgram-b5c73.appspot.com",
    messagingSenderId: "437784331312",
    appId: "1:437784331312:web:146e228ed6edb5e6d159f5"
  };
...
const FBAuth = (request, response, next) => {
    ...
    if (request.headers.authorization && request.headers.authorization.startsWith('Bearer ')) {
        ...
        return response.status(403).json({error : "unauthorization"});
    }
    admin.auth().verifyIdToken(idToken).then(decodedToken => {
        ...
        return response.status(403).json(errr)
    })
}
